...
@section('content')
    ...
    <div class="content">
                ...
                <div class="banner_container">
                    <div class="banner_container__button">
                        <a href="{{ $settings->getAttribute('general_settings')['tg'] }}" target="_blank" rel="noopener">
                            <button onclick="gtag('event', 'click', {'event_category':'Click'})" class="tg"><svg width="19" height="17" viewBox="0 0 19 17" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <section class="kwest">
            <div class="container">
                <div class="kwest_cont_kanye_top">
